<x-app-layout>
    ...
    <div class="py-8 max-w-4xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white shadow-sm rounded-md p-6">
            <form action="{{ route('catches.update', $catch) }}" method="post" class="space-y-6" id="catchForm">
                @csrf
                @method('PATCH')
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('catches.show', $catch) }}" class="text-sm text-gray-600 hover:text-gray-800">{{ __('Cancel') }}</a>
                </div>
            </form>
        </div>
    </div>
